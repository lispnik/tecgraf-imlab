...
static int cmAbout(void)
{
  ...
  _vbox_2 = IupVbox(
    ...
    IupLabel("Copyright © 1995-2020 Antonio Scuri"),
...
Ihandle* imlabMainWindowCreateMenu(void)
{
  ...
  mnHelp = IupMenu(
    ...
    IupSeparator(),
    IupSetAttributes(imlabItem("Libraries...", "imlabLibraries"), "IMAGE=IUP_Tecgraf"),
    IupSetAttributes(imlabItem( "About...", "imlabAbout"), "IMAGE=imlabLogo"),
    NULL);
  ...
  IupSetFunction("imlabLibraries", (Icallback)cmLibraries);
